...
pub enum LeafContents {
    ...
    GetStarted,
    /// An embedded WebView2 browser pane. Not persisted across restarts because the native
    /// child HWND can't be serialized/restored.
    Browser,
}
...
impl LeafContents {
    ...
    pub(crate) fn is_persisted(&self) -> bool {
        match self {
            ...
            // Browser panes hold a native WebView2 child HWND that can't survive
            // serialization/restart, same rationale as NetworkLog.
